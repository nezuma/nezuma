# Проект написанный на vue и node
vue.js - фронт<br>
node.js - бек<br>
# Что делает сайт?
Это сайт-игра кликер, в которой реализованы такие возможности: регистрация, авторизация, верифифкация по одноразовому токену(без его обновления, как обычно делают), клик и запись коинов(внутреигровая валюта), чат.<br>
